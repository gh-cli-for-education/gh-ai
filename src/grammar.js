...
var grammar = {
    ...
    {"name": "extensionProperties$ebnf$2$subexpression$1", "symbols": ["functions"], "postprocess": id},
    ...
    {"name": "extensionProperties$ebnf$5$subexpression$1", "symbols": ["functions"], "postprocess": id},
    {"name": "extensionProperties$ebnf$5", "symbols": ["extensionProperties$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "extensionProperties$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "extensionProperties$ebnf$8$subexpression$1$subexpression$1", "symbols": [(LEXER.has("HIGHLIGHT") ? {type: "HIGHLIGHT"} : HIGHLIGHT)], "postprocess": id},
    {"name": "extensionProperties$ebnf$8$subexpression$1$subexpression$1", "symbols": [(LEXER.has("PARAGRAPH") ? {type: "PARAGRAPH"} : PARAGRAPH)], "postprocess": id},
    {"name": "extensionProperties$ebnf$8$subexpression$1", "symbols": ["extensionProperties$ebnf$8$subexpression$1$subexpression$1", (LEXER.has("CODEBLOCK") ? {type: "CODEBLOCK"} : CODEBLOCK)], "postprocess": buildExample},
    {"name": "extensionProperties$ebnf$8", "symbols": ["extensionProperties$ebnf$8$subexpression$1"]},
    {"name": "extensionProperties$ebnf$8$subexpression$2$subexpression$1", "symbols": [(LEXER.has("HIGHLIGHT") ? {type: "HIGHLIGHT"} : HIGHLIGHT)], "postprocess": id},
    {"name": "extensionProperties$ebnf$8$subexpression$2$subexpression$1", "symbols": [(LEXER.has("PARAGRAPH") ? {type: "PARAGRAPH"} : PARAGRAPH)], "postprocess": id},
    {"name": "extensionProperties$ebnf$8$subexpression$2", "symbols": ["extensionProperties$ebnf$8$subexpression$2$subexpression$1", (LEXER.has("CODEBLOCK") ? {type: "CODEBLOCK"} : CODEBLOCK)], "postprocess": buildExample},
    ...
    {"name": "functions$ebnf$1$subexpression$1", "symbols": [(LEXER.has("CODEBLOCK") ? {type: "CODEBLOCK"} : CODEBLOCK)], "postprocess": id},
    {"name": "functions$ebnf$1", "symbols": ["functions$ebnf$1$subexpression$1"]},
    {"name": "functions$ebnf$1$subexpression$2", "symbols": [(LEXER.has("CODEBLOCK") ? {type: "CODEBLOCK"} : CODEBLOCK)], "postprocess": id},
    {"name": "functions$ebnf$1", "symbols": ["functions$ebnf$1", "functions$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "functions", "symbols": [(LEXER.has("FUNCTIONS") ? {type: "FUNCTIONS"} : FUNCTIONS), "functions$ebnf$1"], "postprocess": buildFunctions},
