...
var grammar = {
    Lexer: LEXER,
    ParserRules: [
    {"name": "inputObject$ebnf$1", "symbols": []},
    {"name": "inputObject$ebnf$1$subexpression$1", "symbols": ["mainProperties"], "postprocess": id},
    {"name": "inputObject$ebnf$1", "symbols": ["inputObject$ebnf$1", "inputObject$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "inputObject", "symbols": ["inputObject$ebnf$1", (LEXER.has("EOF") ? {type: "EOF"} : EOF)], "postprocess": buildInputObject},
    ...
    {"name": "extension$ebnf$1$subexpression$1", "symbols": ["extensionProperties"], "postprocess": id},
    ...
    {"name": "extension", "symbols": [(LEXER.has("EXTENSION") ? {type: "EXTENSION"} : EXTENSION), "description", "extension$ebnf$1"], "postprocess": buildExtension},
    {"name": "extensionProperties", "symbols": ["languageSettings"], "postprocess": id},
    {"name": "extensionProperties", "symbols": ["function"], "postprocess": id},
    {"name": "extensionProperties", "symbols": ["help"], "postprocess": id},
    {"name": "extensionProperties", "symbols": ["examples"], "postprocess": id},
    {"name": "extensionProperties", "symbols": ["readme"], "postprocess": id},
    ...
    {"name": "descriptionBlock", "symbols": [(LEXER.has("ITEM_LIST") ? {type: "ITEM_LIST"} : ITEM_LIST)], "postprocess": id},
    ...
    {"name": "template", "symbols": [(LEXER.has("TEMPLATE") ? {type: "TEMPLATE"} : TEMPLATE), (LEXER.has("CODEBLOCK") ? {type: "CODEBLOCK"} : CODEBLOCK)], "postprocess": id => id[1]},
    ...
    {"name": "readme", "symbols": [(LEXER.has("README") ? {type: "README"} : README), "sections"], "postprocess": buildReadme},
