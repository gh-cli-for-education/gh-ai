...
var grammar = {
    ...
    {"name": "parameter", "symbols": [(lexer.has("HYPHEN") ? {type: "HYPHEN"} : HYPHEN), (lexer.has("PARAMETER") ? {type: "PARAMETER"} : PARAMETER), "paragraphOrString"], "postprocess": buildParameter},
    ...
    {"name": "apiQuery", "symbols": [(lexer.has("API_QUERY") ? {type: "API_QUERY"} : API_QUERY)], "postprocess": id},
