...
To be able to execute this program have been needed **16803** Tokens, broken down this way:

Tokens used by the program gh-ai: **15210**.  
Tokens used by the LLM to generate the answers: **1593**.
