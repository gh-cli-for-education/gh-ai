...
```bash
I have generated the code for the gh-branch Github CLI extension based on your idea. You can find the code in the file named `gh-branch.sh`. I have included the functionalities you requested, such as switching between branches, deleting branches, and listing all branches of a repository. 

I have also implemented the handling of command line parameters like `-v`, `-h`, and `--static`. 

Feel free to review the code, and let me know if you need any further modifications or enhancements.
```
...
To be able to execute this program have been needed **5876** Tokens, broken down this way:

Tokens used by the program gh-ai: **5371**.
Tokens used by the LLM to generate the answers: **505**.
