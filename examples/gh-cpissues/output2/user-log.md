...
To be able to execute this program have been needed **19830** Tokens, broken down this way:

Tokens used by the program gh-ai: **17582**.  
Tokens used by the LLM to generate the answers: **2248**.
