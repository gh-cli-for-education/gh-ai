...
To be able to execute this program have been needed **20246** Tokens, broken down this way:

Tokens used by the program gh-ai: **17207**.  
Tokens used by the LLM to generate the answers: **3039**.
