...
To be able to execute this program have been needed **14524** Tokens, broken down this way:

Tokens used by the program gh-ai: **13146**.  
Tokens used by the LLM to generate the answers: **1378**.
