...
Next we have the json object created from the user's submitted information located on the `./examples/gh-poi/gh-poi.md` file. 
...
To be able to execute this program have been needed **41085** Tokens, broken down this way:

Tokens used by the program gh-ai: **38641**.  
Tokens used by the LLM to generate the answers: **2444**.
